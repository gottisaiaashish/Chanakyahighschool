...
const testimonialsData1 = [
  {
    text: "My daughter has been studying in this school for past 8 years. But this year she changed in a remarkable way. Such as, speaking and writing skills... She also became so disciplined.",
    name: "P. Pavani",
    role: "Parent of P. Akshaya, Class 10",
    image: "https://ui-avatars.com/api/?name=P+Pavani&background=041E42&color=fff&size=128"
  },
  {
    text: "The teachers are extremely supportive and always focus on the child's individual progress. My son has improved his math scores significantly since joining.",
    name: "S. Anitha",
    role: "Parent of S. Rahul, Class 7",
    image: "https://ui-avatars.com/api/?name=S+Anitha&background=D4AF37&color=041E42&size=128"
  }
];

const testimonialsData2 = [
  {
    text: "I am fully satisfied with the school. My child's behaviour is very good and there is noticeable growth in knowledge. I appreciate your willingness to listen to parents concern.",
    name: "Ramakrishna",
    role: "Parent, U.K.G.",
    image: "https://ui-avatars.com/api/?name=Ramakrishna&background=D4AF37&color=041E42&size=128"
  },
  {
    text: "We are amazed by the campus facilities and the focus on extracurricular activities. It's not just academics; they really build the child's overall personality.",
    name: "Ramesh Babu",
    role: "Parent of R. Karthik, Class 5",
    image: "https://ui-avatars.com/api/?name=Ramesh+Babu&background=041E42&color=fff&size=128"
  }
];

const testimonialsData3 = [
  {
    text: "School lo Discipline bavundi. Assembly programme conduct cheyadam bavundi. Daily news Reading manchi alavatu. Spoken English develop cheyadam bavundi.",
    name: "K. Rajashekhar Reddy",
    role: "Parent of K. Pranav, Class 3",
    image: "https://ui-avatars.com/api/?name=K+Rajashekhar&background=041E42&color=fff&size=128"
  },
  {
    text: "Best decision we made for our kids. The management is very approachable, and the safety measures on campus give us complete peace of mind.",
    name: "V. Lakshmi",
    role: "Parent of V. Harsha, Class 8",
    image: "https://ui-avatars.com/api/?name=V+Lakshmi&background=D4AF37&color=041E42&size=128"
  }
];

export const TestimonialsColumn = (props) => {
  return (
    <div className={`testimonials-col-wrapper ${props.className || ''}`}>
      <motion.div
        ...
        {[...new Array(2).fill(0).map((_, index) => (
          <React.Fragment key={index}>
            {props.testimonials.map(({ text, image, name, role }, i) => (
              <div className="testimonial-anim-card" key={i}>
...
// --- Facilities Accordion Component ---
const facilitiesItems = [
  ...
  },
  {
    ...
    imageUrl: 'https://chanakyahighschoolwnp.com/assets/library1.jpeg',
  },
  {
    id: 3,
    title: 'Computer Labs',
    imageUrl: 'https://chanakyahighschoolwnp.com/assets/computerLab.jpeg',
  },
  {
    id: 4,
    title: 'Sports Grounds',
    imageUrl: 'https://chanakyahighschoolwnp.com/assets/articles/sports.jpeg',
  },
  {
    id: 5,
    title: 'Science Labs',
...
const achievementsData = [
  {
    id: 1,
    title: "Indian Talent Olympiad 2025",
    description: "Our bright girl students secured top ranks in the state.",
    imageSrc: "https://chanakyahighschoolwnp.com/assets/articles/olympaidClassGirls.jpeg",
    objectPosition: "top"
  },
  {
    id: 2,
    title: "SSC Results 2024-25",
    description: "Celebrating the great marks scored by our 10th class batch.",
    imageSrc: "https://chanakyahighschoolwnp.com/assets/articles/results24-25.jpg",
    objectPosition: "top"
  },
  {
    id: 3,
    title: "Motivational Speech by SP",
    description: "Special guidance session by Wanaparthy SP, Sri R Giridhar, IPS.",
    imageSrc: "https://chanakyahighschoolwnp.com/assets/articles/Motivational%20Speech%20by%20SP%20Wanaparthy%20%20Sri%20R%20Giridhar,IPS.jpeg",
    objectPosition: "center 40%"
  },
  {
    id: 4,
    title: "Radio Station Visit",
    description: "Special program with District Judge Smt Sunitha.",
    imageSrc: "https://chanakyahighschoolwnp.com/assets/articles/Radio%20station%20Programme%20with%20District%20Judge%20Smt%20Sunitha%20and%20RDS%20President%20Chinnama%20Thomas.jpeg",
    objectPosition: "center 30%"
  },
  {
    id: 5,
    title: "Alumnae Inspiration",
    description: "Group I Winners Fahemeena and Suma sree inspiring the students.",
    imageSrc: "https://chanakyahighschoolwnp.com/assets/articles/Motivational%20speech%20by%20School%20Alumnae%20and%20Group%20I%20Winners%20Fahemeena%20and%20Suma%20sree.jpeg",
    objectPosition: "top"
  },
  {
    id: 6,
    title: "Doctor's Advice",
    description: "Dr. R Sridivya interacting and sharing health advice with our students.",
    imageSrc: "https://chanakyahighschoolwnp.com/assets/articles/Alumna.jpg",
    objectPosition: "top"
  }
];

const FacilityAccordionItem = ({ item, isActive, onMouseEnter }) => {
  return (
    <div
      className={`facility-accordion-item ${isActive ? 'active' : ''}`}
      onMouseEnter={onMouseEnter}
    >
      <img src={item.imageUrl} alt={item.title} className="facility-img" />
      <div className="facility-overlay"></div>
      <span className="facility-caption">
        {item.title}
      </span>
    </div>
  );
  ...
  return (
    <section id="campus" className="section section-light">
      <div className="campus-container">
        ...
        <div className="content-block campus-text">
          <span className="badge">Campus Life</span>
          <h2 className="serif" style={{ fontSize: '3rem', marginBottom: '1.5rem', color: 'var(--primary)' }}>Beyond Books</h2>
          <p style={{ fontSize: '1.15rem' }}>
            School life is more than just reading books. We encourage students to play games, participate in dance and singing, and join competitions to make them bold and healthy.
          </p>
          <p style={{ fontSize: '1.15rem' }}>
            Experience our world-class facilities designed to foster holistic development and creative thinking.
          </p>
          <a href="#admissions" className="btn btn-primary" style={{ marginTop: '2rem' }}>Visit Our Campus</a>
        </div>

        {/* Right Side: Image Accordion */}
        <div className="campus-accordion">
...
const AnimatedGroup = ({ children, className, variants }) => {
  return (
    <motion.div
      initial="hidden"
      whileInView="visible"
    ...
    >
      {React.Children.map(children, (child, index) => (
        <motion.div key={index} variants={variants.item} className="flex justify-center items-center">
          {child}
        </motion.div>
      ))}
    </motion.div>
...
const partnersLogos = [
  { src: "https://logo.clearbit.com/iitb.ac.in", alt: "IIT Bombay" },
  { src: "https://logo.clearbit.com/nitw.ac.in", alt: "NIT Warangal" },
  { src: "https://logo.clearbit.com/bits-pilani.ac.in", alt: "BITS Pilani" },
  { src: "https://logo.clearbit.com/osmania.ac.in", alt: "Osmania University" },
  { src: "https://logo.clearbit.com/tcs.com", alt: "TCS" },
  { src: "https://logo.clearbit.com/infosys.com", alt: "Infosys" },
  { src: "https://logo.clearbit.com/wipro.com", alt: "Wipro" },
  ...
  return (
    <section className="section partners-section">
      <div className="section-title" style={{ marginBottom: '2rem' }}>
        <h2>Where Our Alumni Are Today</h2>
        <div className="divider"></div>
        <p>Our past students have gone on to join top universities and global companies.</p>
      </div>
      
      <div className="partners-container group">
        <div className="partners-hover-overlay">
          <a href="#about" className="partners-hover-link">
...
export const CustomFooter = () => {
  ...
  return (
   <div className="custom-footer" id="contact">
      <div className="custom-footer-card">
        <div className="footer-tape footer-tape-left">
          {tape}
        </div>
        <div className="footer-tape footer-tape-right">
          {tape}
        </div>
        ...
        <div className="footer-col" style={{ flex: '1.5' }}>
          <a href="#" className="footer-logo-text">
            ...
            <span className="footer-logo-sub">School of Joy and Excellence</span>
          </a>
          <p className="footer-desc">Giving quality education, great facilities, and strong moral values to the children of Wanaparthy since 2005.</p>
          <div style={{ marginTop: '1rem', color: 'var(--text-dark)', fontSize: '0.9rem', fontWeight: '500' }}>
            📞 +91 9491532869<br/>
            📧 chanakya.wnp@gmail.com
          </div>
        </div>
        ...
        <div className="footer-col" style={{ flex: '1' }}>
          ...
          <div className="footer-link-list">
            ...
            <a href="#academics">Classes & Structure</a>
        ...
        <div className="footer-col" style={{ flex: '1' }}>
          ...
          <div className="footer-link-list">
            <a href="#">Mandatory Public Disclosure</a>
      ...
      <div className="footer-bottom-bar">
        <div>
          © {currentYear} Chanakya High School. All rights reserved. Designed by Sai Aashish Gotti.
        </div>
...
function TextGradientScroll({ text, className }) {
  ...
  return (
    <TextGradientScrollContext.Provider value={{}}>
      <p ref={ref} className={`relative flex flex-wrap m-0 ${className || ""}`}>
        {words.map((word, i) => {
...
const Letter = ({ children, progress, range }) => {
  ...
  return (
    <span style={{ marginRight: '0.3em', display: 'inline-flex' }}>
...
const Char = ({ children, progress, range }) => {
  ...
  return (
    <span style={{ position: 'relative', display: 'inline-block' }}>
      <span style={{ position: 'absolute', opacity: 0.1, color: 'var(--text-dark)' }}>{children}</span>
      <motion.span style={{ opacity: opacity, color: 'var(--primary)' }}>
        {children}
      </motion.span>
    </span>
  );
  ...
  return (
    <>
      ...
      <div className="top-bar">
        <div>
          <span>Phone: +91 9491532869 | 8500175839</span>
          <span style={{ marginLeft: '2rem' }}>Email: chanakya.wnp@gmail.com</span>
        </div>
        <div className="top-bar-links">
          <a href="#admissions">Admissions 2025-26</a>
      ...
      <nav className="nav">
        <a href="#" className="logo-container">
          <h1>Chanakya High School</h1>
          <span>School of Joy and Excellence</span>
        </a>
      ...
      <section className="hero">
        <video autoPlay loop muted playsInline className="hero-video">
          <source src="https://chanakyahighschoolwnp.com/assets/video.mp4" type="video/mp4" />
        </video>
        <div className="hero-overlay"></div>
        
        <div className="hero-content">
          <span className="hero-subtitle">Established 2005</span>
      ...
      <section className="section" style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem 5%' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <TextGradientScroll 
            text="Education is not just about memorizing facts. It is about training the mind to think, the heart to feel, and the hands to build a better future." 
      ...
      <section id="about" className="section">
        <div className="grid-2">
          <div className="content-block">
            ...
            <h2 className="serif">Education is a Beautiful Journey</h2>
            <p>
              Chanakya High School was started with a simple dream: to give children a happy, value-based education. We mix our strong Indian traditions with modern teaching methods to make learning fun and interesting.
            </p>
            <p>
              Our goal is to make every child confident, honest, and ready for the future. We want our students to be good human beings who help society. At Chanakya, we don't just talk about good habits; we practice them every day.
            </p>
            <a href="#academics" className="btn btn-primary" style={{ marginTop: '1.5rem' }}>See Our Classes</a>
          </div>
          <div className="image-box" style={{ overflow: 'hidden', borderRadius: '1.5rem', position: 'relative' }}>
            <video 
              src="https://chanakyahighschoolwnp.com/assets/video.mp4" 
              autoPlay 
              muted 
              loop 
              playsInline 
      ...
      <section className="section section-light" style={{ textAlign: 'center' }}>
        <div className="section-title">
          <h2>Growing With Good Habits</h2>
          <div className="divider"></div>
          <p>Every year, our students make a special promise to follow a good habit throughout the school year.</p>
        </div>
        <div>
          <span className="value-tag">“Being a candle in darkness”</span>
          <span className="value-tag">“Limiting screen time & living your dreams”</span>
        </div>
      </section>
      ...
      <section className="section">
        <div className="section-title">
          <h2>Words from Our Management</h2>
          <div className="divider"></div>
        </div>
        <div className="grid-2">
          <div className="message-card">
            ...
            <p>
              It is my honor and privilege to be a part of Chanakya School.<br/><br/>
              Education is a lifelong journey, one that must spark curiosity, creativity, critical thinking, and enthusiasm in every child. Our goal is to nurture students through intellectually stimulating learning and a practical, real-world approach. We are proud to have a team of highly qualified, dedicated teachers who bring energy and commitment to the classroom every day.
            </p>
            <div className="message-author">— G Venkat</div>
          </div>
          ...
          <div className="message-card">
            ...
            <p>
              "Education is the journey of growing hearts and shaping minds. At Chanakya, we believe in balancing academic strength with human values."
            </p>
            <div className="message-author">— Saju Paul K</div>
          </div>
        </div>
      </section>
      ...
      {/* Academics & Structure */}
      <section id="academics" className="section section-light">
        <div className="section-title">
          <h2>Our Classes</h2>
          <div className="divider"></div>
          <p>We plan our teaching carefully so that every child learns easily step-by-step.</p>
        </div>
        
        <div className="grid-2">
          <div className="feature-card" style={{ borderLeft: '4px solid var(--primary)', background: 'var(--white)', padding: '2.5rem' }}>
            <h3 style={{ fontSize: '1.8rem', color: 'var(--primary)', marginBottom: '0.5rem' }}>Junior Champs</h3>
            <span className="badge" style={{ display: 'inline-block', marginBottom: '1.5rem', background: 'rgba(4, 30, 66, 0.1)', color: 'var(--primary)' }}>Nursery to Class 5 (CBSE)</span>
            <p style={{ fontSize: '1.1rem', lineHeight: '1.6' }}>
              We start with fun activities to make small children love coming to school. They learn the basics of reading, writing, and numbers in a very happy environment.
            </p>
          </div>

          <div className="feature-card" style={{ borderLeft: '4px solid var(--accent)', background: 'var(--white)', padding: '2.5rem' }}>
            <h3 style={{ fontSize: '1.8rem', color: 'var(--primary)', marginBottom: '0.5rem' }}>Senior Stars</h3>
            <span className="badge" style={{ display: 'inline-block', marginBottom: '1.5rem', background: 'rgba(212, 175, 55, 0.2)', color: 'var(--text-dark)' }}>Class 6 to 10 (State Board + IIT)</span>
            <p style={{ fontSize: '1.1rem', lineHeight: '1.6' }}>
              For older students, we focus strictly on Science, Math, and deep thinking. Our special IIT coaching prepares them perfectly for higher studies and big exams.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="achievements" className="section section-light" style={{ overflow: 'hidden' }}>
        <div className="section-title">
          <h2>Our Achievements & Proud Moments</h2>
          <div className="divider"></div>
        </div>
        <div style={{ padding: '2rem 0', display: 'flex', justifyContent: 'center' }}>
          <CardStack items={achievementsData} autoAdvance={true} maxVisible={7} />
        </div>
      </section>

      {/* Campus Life & Student Activities (Image Accordion) */}
      <CampusFacilities />
      ...
      <section className="section section-light">
        ...
        <div className="testimonials-section">
          <TestimonialsColumn testimonials={testimonialsData1} duration={15} />
          <TestimonialsColumn testimonials={testimonialsData2} duration={19} className="hidden-mobile" />
          <TestimonialsColumn testimonials={testimonialsData3} duration={17} className="hidden-mobile" />
        </div>
      </section>
      ...
      <section id="admissions" className="section">
        <div className="section-title">
          ...
          <div className="divider"></div>
          <p>Fill out the details below. Our office staff will call you to explain the admission process and fees details.</p>
        </div>

        <div className="grid-2" style={{ alignItems: 'flex-start', gap: '3rem' }}>
          
          <div className="admissions-container" style={{ width: '100%', margin: 0, padding: 0, background: 'transparent', boxShadow: 'none' }}>
            <AdmissionForm />
          </div>
          ...
          <div>
            <div className="content-block">
              ...
              <p style={{ marginBottom: '0.5rem' }}><strong>1. Call or Visit:</strong> Contact or visit our school office during working hours.</p>
              <p style={{ marginBottom: '0.5rem' }}><strong>2. Collect Form:</strong> Take the admission form from the office and fill it.</p>
              <p style={{ marginBottom: '0.5rem' }}><strong>3. Submit Documents:</strong> Give the form with Photos and Aadhar copy.</p>
            </div>
            
            <div className="timings-box">
              <h4>School Timings</h4>
              <div className="timing-row">
                <span>Nursery to 5th Class</span>
                <span>Mon-Fri: 8:45 AM – 4:35 PM | Sat: 8:45 AM – 4:00 PM</span>
              </div>
              <div className="timing-row" style={{ borderBottom: 'none', paddingBottom: 0, marginBottom: 0 }}>
                <span>6th to 10th Class</span>
                <span>Mon-Fri: 8:45 AM – 5:10 PM | Sat: 8:45 AM – 4:10 PM</span>
              </div>
            </div>
          </div>
